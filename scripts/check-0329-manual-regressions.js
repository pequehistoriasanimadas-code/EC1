...
ok(legacy.includes('Aprendizaje de pronunciación actualizado.')&&legacy.includes('migrationReport||p?.migrationInfo')&&!legacy.includes('alert(parts.join')&&legacy.includes("status(text)"), 'la ruta histórica de pronunciación debe conservar el aviso sin popup bloqueante');
