...
app.whenReady().then(async()=>{try{
  ...
  assert(prod.includes("const PROFILE_VERSION='2.0-lab.17'"));

  console.log('PACKAGED V2 LATAM ONLY lab.17 OK · no Multilingual route · consistency comparison packaged');
  app.exit(0);
