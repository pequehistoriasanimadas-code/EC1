...
const current=JSON.parse(fs.readFileSync(pkgFile,'utf8'));if(current.version!=='0.3.22'){console.error('No se restauró package.json 0.3.22 después de checks compatibles');process.exit(1);}console.log('Checks históricos 0.3.16–0.3.21 ejecutados en modo compatible y package 0.3.22 restaurado.');
