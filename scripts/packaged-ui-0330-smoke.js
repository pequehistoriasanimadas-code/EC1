...
app.whenReady().then(async()=>{let win=null;try{
  ...
  win.destroy();console.log('PACKAGED REAL UI 0.3.30 OK · onboarding cancel · tuning global · cola efectiva · preparación separada · Fondos y casillas responsive · responsive general');app.exit(0);
