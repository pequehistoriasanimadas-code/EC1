...
assert.strictEqual(pkg.version,'2.0.0-lab.12','La build debe identificarse como 2.0.0-lab.12');
...
assert(baseOptimizerUi.includes('ttsLabel0321')&&baseOptimizerUi.includes('ttsLabStatus')&&baseOptimizerUi.includes("version:'2.0-lab.12'")&&baseOptimizerUi.includes('ttsLabStop')&&baseOptimizerUi.includes('ttsLabValidateSelected'),'Optimizador base V2 debe prevalidar Qwen, liberar TTS antes de Qwen local y usar la GPU CUDA real');
...
console.log('check-v2lab: OK · lab.12 · CUDA v2 transaccional · aislamiento Chatterbox/Qwen · Qwen speed autotune · GPU SWAP');
