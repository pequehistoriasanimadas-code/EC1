...
(async()=>{
  ...
  assert(renderer.includes("window.__GEC_V2LAB_RENDERER_RESPONSIVE__='lab15'"),'Renderer debe identificar el hardening de responsividad lab.15');
  ...
  const temp=fs.mkdtempSync(path.join(os.tmpdir(),'gec-lab15-responsive-'));
  try{
