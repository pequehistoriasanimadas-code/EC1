...
(async()=>{
  ...
  assert(renderer.includes("window.__GEC_V2LAB_RENDERER_RESPONSIVE__='lab16'"),'Renderer debe identificar el hardening de responsividad lab.16');
  ...
  const temp=fs.mkdtempSync(path.join(os.tmpdir(),'gec-lab16-responsive-'));
  try{
