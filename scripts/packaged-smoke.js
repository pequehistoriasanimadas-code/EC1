...
app.whenReady().then(async()=>{
  ...
  try{
    ...
    // copia mediante PYTHONPATH, copiar DLL/datos a su runtime corto controlado
    // y mantener español disponible antes de producir audio.
