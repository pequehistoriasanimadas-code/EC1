...
app.whenReady().then(()=>{try{
  ...
  assert(runtime.CACHE_REVISION==='lab11-r1','Cache TTS empaquetada no corresponde a lab.19');
  console.log('PACKAGED V2 PIPELINE lab.19 OK · 5 noticias · pronunciación liberada · anti-starvation · watchdog · RTF');
  app.exit(0);
