...
app.whenReady().then(async()=>{let tmp='';try{
  ...
  fs.rmSync(tmp,{recursive:true,force:true});console.log('PACKAGED 0.3.31 AUDIT OK · exclusivas estables entre refrescos · posiciones secuenciales · contenido exacto · anuncio bloqueado');app.exit(0);
