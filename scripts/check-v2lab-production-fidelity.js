...
(async()=>{
  ...
  assert(bootstrap.includes('releaseV2ProductionFidelity'),'Capa lab.20 no instalada');
  ...
  try{
    ...
    const profile={
      schemaVersion:1,version:'2.0-lab.20',id:'test-profile',at:new Date().toISOString(),
