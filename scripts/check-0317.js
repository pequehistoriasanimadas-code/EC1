...
try{
  ...
  const chosen=selectAdvancedCandidate([
    {id:'fast',safe:true,realtimeFactor:1,cpuAverage:30},
    {id:'efficient',safe:true,realtimeFactor:1.02,cpuAverage:15},
    {id:'slow',safe:true,realtimeFactor:1.10,cpuAverage:8}
  ],{tolerance:.03});ok(chosen?.id==='efficient','la selección no conserva margen de CPU dentro del 3% del mejor RTF');
