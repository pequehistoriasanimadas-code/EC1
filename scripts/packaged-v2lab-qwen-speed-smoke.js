...
app.whenReady().then(async()=>{try{
  ...
  assert(ui.includes('ttsLabBenchmarkPerformance')&&ui.includes('OPTIMIZADA · VOZ LENTA')&&ui.includes("version:'2.0-lab.14'"),'Unified optimizer lab.14 UI not packaged');
  ...
  console.log('PACKAGED V2 QWEN SPEED lab.14 OK · autotune · FP16/SDPA · chunk guard · state sync');
  app.exit(0);
