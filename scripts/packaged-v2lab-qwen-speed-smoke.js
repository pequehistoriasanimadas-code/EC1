...
app.whenReady().then(async()=>{try{
  ...
  assert(ui.includes('ttsLabBenchmarkPerformance')&&ui.includes('OPTIMIZADA · VOZ LENTA')&&ui.includes("version:'2.0-lab.17'"),'Unified optimizer lab.17 UI not packaged');
  ...
  console.log('PACKAGED V2 QWEN SPEED lab.17 OK · autotune · FP16/SDPA · chunk guard · state sync');
  app.exit(0);
