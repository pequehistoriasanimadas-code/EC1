...
(async()=>{
  ...
  assert(prod.includes('processing-stop-lab16')&&prod.includes('Promise.allSettled'),'Detener preparación debe liberar motores/GPU');
  ...
  const tmp=fs.mkdtempSync(path.join(os.tmpdir(),'gec-lab16-ref-'));
  try{
