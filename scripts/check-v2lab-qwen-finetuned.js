...
(async()=>{
  ...
  try{
    ...
    assert(optimizerUi.includes("version:'2.0-lab.14'")&&optimizerUi.includes('Qwen local (texto)')&&optimizerUi.includes('GPU SWAP'),'Optimizador lab.14 debe distinguir texto/voz y mostrar GPU SWAP');
