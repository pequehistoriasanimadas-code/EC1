...
(async()=>{
  ...
  try{
    ...
    assert(optimizerUi.includes("version:'2.0-lab.25'")&&optimizerUi.includes('Qwen local (texto)')&&optimizerUi.includes('GPU SWAP'),'Optimizador lab.23 debe distinguir texto/voz y mostrar GPU SWAP');
