...
app.whenReady().then(async()=>{try{
  ...
  assert(prod.includes("const PROFILE_VERSION='2.0-lab.18'")&&prod.includes('chunkChars:540')&&prod.includes('processing-stop-lab17'));
  ...
  console.log('PACKAGED V2 VOICE CONSISTENCY lab.18 OK · natural speed · stable Chatterbox/Qwen · reference QA · session lock · safe cancel');
  app.exit(0);
