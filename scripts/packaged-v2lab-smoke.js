...
app.whenReady().then(()=>{let tmp='';try{
  ...
  assert(pkg.version==='2.0.0-lab.7','Versión empaquetada no es V2 TTS Lab 2.0.0-lab.7');
  ...
  console.log('PACKAGED V2 TTS LAB lab.7 OK · GPU coordinada · telemetría · velocidad · herencia 0.3.32 preservada');
  app.exit(0);
