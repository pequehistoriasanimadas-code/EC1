...
app.whenReady().then(()=>{let tmp='';try{
  ...
  assert(pkg.version==='2.0.0-lab.12','Versión empaquetada no es V2 TTS Lab 2.0.0-lab.12');
  ...
  console.log('PACKAGED V2 TTS LAB lab.12 OK · LatAm · warm-up/cache versionada · watchdog · GPU coordinada · herencia 0.3.32 preservada');
  app.exit(0);
