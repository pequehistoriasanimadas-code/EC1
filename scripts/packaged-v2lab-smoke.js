...
app.whenReady().then(()=>{let tmp='';try{
  ...
  assert(pkg.version==='2.0.0-lab.6','Versión empaquetada no es V2 TTS Lab 2.0.0-lab.6');
  ...
  console.log('PACKAGED V2 TTS LAB lab.6 OK · cache de referencias · Qwen fine-tuned · herencia 0.3.32 preservada');
  app.exit(0);
