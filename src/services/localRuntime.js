...
class LocalRuntime{
  constructor({resourcesDir,dataDir,onEvent=()=>{}}){
    ...
    this.server=null;this.port=8766;this.startingPromise=null;this.downloadPromise=null;this.idleTimer=null;this.idleDeadline=0;this.resourceMode='safe_streaming';this.generationTail=Promise.resolve();this.generationActive=false;fs.mkdirSync(this.modelDir,{recursive:true});
  }
