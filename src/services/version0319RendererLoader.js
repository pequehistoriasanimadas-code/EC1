...
require('./version0322Policy').installVersion0322Policy();
require('./version0323Policy').installVersion0323Policy();
...
function installVersion0319RendererLoader(){
  ...
  app.on('web-contents-created',(_,contents)=>{
    if(!contents?.on)return;contents.on('did-finish-load',()=>{
      try{const url=String(contents.getURL?.()||'');if(!/control\.html(?:\?|$)/i.test(url))return;contents.executeJavaScript(`(()=>{if(window.__ec0319LoaderInjected)return;window.__ec0319LoaderInjected=true;const s=document.createElement('script');s.src='renderer-0319.js';s.onerror=()=>console.error('No se pudo cargar renderer-0319.js');s.onload=()=>{if(window.__ec0320LoaderInjected)return;window.__ec0320LoaderInjected=true;const n=document.createElement('script');n.src='renderer-0320.js';n.onerror=()=>console.error('No se pudo cargar renderer-0320.js');n.onload=()=>{if(window.__ec0321LoaderInjected)return;window.__ec0321LoaderInjected=true;const p=document.createElement('script');p.src='renderer-0321.js';p.onerror=()=>console.error('No se pudo cargar renderer-0321.js');p.onload=()=>{if(window.__ec0322LoaderInjected)return;window.__ec0322LoaderInjected=true;const q=document.createElement('script');q.src='renderer-0322.js';q.onerror=()=>console.error('No se pudo cargar renderer-0322.js');q.onload=()=>{if(window.__ec0323LoaderInjected)return;window.__ec0323LoaderInjected=true;const r=document.createElement('script');r.src='renderer-0323.js';r.onerror=()=>console.error('No se pudo cargar renderer-0323.js');document.body.appendChild(r);};document.body.appendChild(q);};document.body.appendChild(p);};document.body.appendChild(n);};document.body.appendChild(s);})()`,true).catch(()=>{});}catch{}
    });
  });
}
