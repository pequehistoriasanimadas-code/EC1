...
const STRUCTURED_PATTERNS=[
  /\b(?:https?:\/\/|www\.)[^\s,;!?]+/giu,
  /\b[\w.+-]+@[\w.-]+\.[A-Za-z]{2,}\b/gu,
  /(?:S\/\.?|PEN|US\$|USD|\$|€|EUR|£|GBP|JPY|CNY|RMB|¥)\s*[+-]?\d[\d.,]*(?:\s*(?:millones?|billones?|miles?|mil))?/giu,
  /[+-]?\d[\d.,]*\s*%/gu,
  /\b\d{1,2}[:.]\d{2}\s*(?:[ap]\.?\s*m\.?|h(?:oras?)?|hrs?\.?|horas?)?/giu,
  /\b\d{1,2}[\/-]\d{1,2}[\/-]\d{4}\b/gu,
  /\b\d[\d.,]*\s*°\s*[CF]\b/giu,
  /\b\d[\d.,]*\s*(?:km\/h|m\/s|GB\/s|Mbps|km²|m²|m³|kg|mg|km|cm|mm|ml|l|g|t|GB|MB|TB|MW|kW|ha)\b/giu,
