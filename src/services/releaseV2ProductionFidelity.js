...
async function preflightAutomation(engine){
  ...
  if(!profile&&s.optimization0321){const e=new Error('Existe una optimización anterior, pero falta el perfil de producción compatible lab.22/23/24. Ejecuta Optimizar GEC una vez.');e.code='PRODUCTION_PROFILE_REOPTIMIZE_REQUIRED';throw e;}
...
module.exports={PROFILE_SCHEMA,PROFILE_VERSION,COMPATIBLE_PROFILE_VERSIONS,PROFILE_FILE,profileFile,buildProfile,compatibility,hydrateSettings,migrateLegacy,resolvePipelineMode,expectedVsRuntime,productionProfileFrom,normalizeLocalConfig,sameConfig,installV2ProductionFidelity};
